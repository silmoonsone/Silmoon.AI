...
public class ClientService : BackgroundService
{
    ...
    public ClientService(ISilmoonConfigureService silmoonConfigureService, IHostApplicationLifetime applicationLifetime)
    {
        ...
        NativeChatCompletionsClient = new NativeChatCompletionsClient(SilmoonConfigureService.ApiUrl, SilmoonConfigureService.Key, SilmoonConfigureService.ProviderName, SilmoonConfigureService.ModelName, UtilPrompt.ContextPrompt);
